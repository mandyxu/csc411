...
if __name__ == '__main__':
    ...
    for item in k_list:
        ...
        frac_correct_valid.append((valid_targets == pred_valid).mean())
        frac_correct_test.append((test_targets == pred_test).mean())
        
    # Plot Classification Rate of Validation set.
    print "cr_Validation: \n", frac_correct_valid
    print "cr_Test: \n", frac_correct_test 
    
    mp.axis([1,max(k_list),0.82,1])
    ...
    mp.savefig("2.1_classification_rates.png")
    mp.clf()
       
    
    #plot_digits(train_inputs)
    #plot_digits(valid_inputs)
